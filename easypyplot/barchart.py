...
def draw(axes,
    ...
    xticklabelfontproperties: the FontManager instance applied to the xtick
        labels, including font name, size, etc.. The xticklabelfontsize has a
        higher priority over xticklabelfontproperties.
